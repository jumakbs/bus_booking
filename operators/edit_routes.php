            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800"> <b>UPDATES BUS ROUTE</b></h3>
                    </div>
...
<form action="routes.php" method="POST">
           ...
           <div class="form-group">
                      ...
                      <input type="text" name="via" class="form-control" placeholder="via" value="<?php echo $row1['via']; ?>">
                   </div>
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" name="price" class="form-control" placeholder="Enter phone number" value="<?php echo $row1['price']; ?>">
                   </div>

                  <a href="routes.php" class="btn btn-danger"> CANCEL </a>
